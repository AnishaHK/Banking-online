...
if($_SESSION['randomno'] == $_POST['randomno'])
{
	if(isset($_POST['submit']))
	{
		...
		if(isset($_SESSION['emp_id']))
		{
		echo "<script>window.location='viewcustomerac.php?customeracid=" . $receiver . "';</script>";
		}
 ...
 <span id="jscustomer" ></span>
                ...
                <div class="row">
                          <div class="col-md-12 margin-bottom-15">
                                ...
                                <input type="text" class="form-control" name="subject" placeholder="Subject" value="<?php echo $rsedit[subject]; ?>">  
              ...
              <script>tinymce.init({ selector:'textarea' });</script>
                    <textarea class="form-control" name="message" id="messages" placeholder="Message" rows="15"><?php echo $rsedit[message]; ?></textarea>
